...
class DropAnalysis(GeoAlgorithm):
    ...
    STEPS_DICT = {"Logarithmic":0, "Linear":1}
    ...
    def defineCharacteristics(self):
        ...
        self.addParameter(ParameterSelection(self.STEP_TYPE, "Spacing for Threshold Values", self.STEPS_DICT.keys()))
        self.addOutput(OutputFile(self.DROP_ANALYSIS_FILE, "Output Slope Area Grid"))
    ...
    def processAlgorithm(self, progress):
        ...
        commands.append(str(self.STEPS_DICT[self.getParameterValue(self.STEP_TYPE)]))
        commands.append("-drp")
